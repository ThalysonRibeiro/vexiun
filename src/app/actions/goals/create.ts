...
import { z } from "zod";
import { ERROR_MESSAGES, successResponse, ValidationError, withAuth } from "@/lib/errors";
...
export const createGoal = withAuth(
  async (userId, session, formData: z.infer<typeof formSchema>) => {
