...
export const cancelInvitationSchema = z.object({
  invitationIds: z.array(z.string().cuid(ERROR_MESSAGES.VALIDATION.INVALID_ID)),
  revalidatePaths: z.array(z.string()).optional()
});
...
export const changeWorkspaceStatusSchema = workspaceIdSchema.extend({
  newStatus: z.enum([EntityStatus.ARCHIVED, EntityStatus.ACTIVE, EntityStatus.DELETED]),
  revalidatePaths: z.array(z.string()).optional()
});
