    ...
    <div className="flex items-center gap-2">
      <div className="relative">
        ...
        <div className="relative w-7.5 h-7.5">
          <div
            className="w-4 h-4 bg-primary absolute top-0 left-0"
            style={{
              width: "17px",
              height: "16px",
              borderRadius: "2.5px"
          ...
          />
          <div
            className="bg-orange-500 absolute top-0 right-0"
            style={{
              width: "9px",
              height: "9px",
              borderRadius: "100%"
          ...
          <div
            className="bg-primary rounded absolute bottom-0 left-0"
            style={{
              width: "11px",
              height: "11px",
              borderRadius: "2.5px"
          ...
          />
          <div
            className="bg-orange-500 absolute bottom-0 right-0"
            style={{
              width: "14px",
              height: "18px",
              borderRadius: "2.5px",
      ...
      {showText && <span className={`font-bold ${sizes[size].text}`}>Catalyst</span>}
    </div>
  );
}
